<aside class="main-sidebar fixed offcanvas b-r" data-toggle='offcanvas'>
    <section class="sidebar">
        <ul class="sidebar-menu mt-4">
            <li class="treeview"><a href="panel-page-dashboard7.html#">
            ...
            <li class="treeview"><a href="panel-page-dashboard7.html#"><i class="icon icon-account_box s-24"></i>Users<i
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="panel-page-dashboard7.html#"><i class="icon icon-documents3"></i>Blank Pages<i
                            class=" icon-angle-left  pull-right"></i></a>
                        <ul class="treeview-menu">
                    ...
                    <li><a href="panel-page-dashboard7.html#"><i class="icon icon-fingerprint text-green"></i>Auth Pages<i
                            class=" icon-angle-left  pull-right"></i></a>
                        <ul class="treeview-menu">
                    ...
                    <li><a href="panel-page-dashboard7.html#"><i class="icon icon-bug text-red"></i>Error Pages<i
                            class=" icon-angle-left  pull-right"></i></a>
                        <ul class="treeview-menu">
                    ...
                    <li><a href="panel-page-dashboard7.html#"><i class="icon icon-documents3"></i>Other Pages<i
                            class=" icon-angle-left  pull-right"></i></a>
                        <ul class="treeview-menu">
        ...
        <div class="relative pt-5">
            <div class="user-panel p-4 mb-2">
                <div>
                    <div class="image">
                        <img width="40" src="../assets/admin/img/dummy/u7.png" alt="User Image">
                    </div>
                    <div class="info">
                ...
                <div class="collapse multi-collapse" id="userSettingsCollapse">
                    <div class="list-group mt-3 shadow">
                        ...
                        <a href="panel-page-dashboard7.html#" class="list-group-item list-group-item-action"><i

...
<div id="createForm">
    <div class="row pl-3">
        ...
        <div class="bg-white col-md-4 shadow">
            <div id="extraInfo">
                <form action="" method="POST" id="imgSubmitForm" enctype="multipart/form-data">
                    <h4 class="mt-2 font-weight-bolder pl-2" style="color:royalblue">Page Information</h4>
                    <input id="pageName" type="text" class="form-control" name="pageName" value="<?= $getPageInfo->pname ?>" style="border:1px solid blue; border-radius:5px !important;line-height: 15px !important;" placeholder="Page Name (required)">
                    <input id="pageCategory" type="text" name="pageCategory" value="<?= $getPageInfo->pcategory ?>" class="form-control" style="border:1px solid blue;border-radius:5px !important;line-height: 15px !important;" placeholder="Category (required)">
                    <textarea id="pageDescription" name="pageDescription" cols="30" rows="1" class="form-control" placeholder="Description"><?= $getPageInfo->pdescription ?></textarea>
        ...
        <div class="bg-white shadow col-md-8 pt-4">
            <div class="row">
                <div class="col-md-12">
                    <?php if ($getPageInfo->coverphoto) : ?>
                        <img class="mx-auto" id="coverImg" style="width:98%; height:80%;border-radius: 10px; z-index:-1;" src="../public/uploads/user/<?= $getPageInfo->coverphoto ?>" alt="">
                    <?php else : ?>
            ...
            <div class="row">
                <div class="d-flex">
                    <div class="col-md-3">
                        <?php if ($getPageInfo->coverphoto) : ?>
                            <img class="rounded-circle" id="proImg" style=" width:100%; z-index: 1111; position:relative;top:-100px;left:5px;" src="../public/uploads/user/<?= $getPageInfo->profilepic ?>" alt="">
                        <?php else : ?>
                    ...
                    <div class="col-md-9" style="z-index: 9999; position:relative;top:-60px;">
                        <h2 id="pnameHolder" class="font-weight-bold" style="color:royalblue"><?= $getPageInfo->pname ?></h2>
                        <p id="pcategoryHolder" class=""><?= $getPageInfo->pcategory ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="z-index: 9999; position:relative; top:-90px">
                ...
                <div class="col-md-6 shadow">
                    ...
                    <p id="pdescriptionHolder"><?= $getPageInfo->pdescription ?></p>
                </div>
                <div class="col-md-3"></div>
            </div>

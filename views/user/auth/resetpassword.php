...
{% endblock %}
    ...
    <div class="tab-content">
        ...
        <div class="title h6">Forget Your Password</div>
            <form action="reset-password" id="resetPassForm" method="post" class="content">
                <div class="row" id="resetPassFormElements">
                    <div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <button type="button" id="resetPassBtn" data-loading="<i class='fa fa-refresh fa-spin fa-1x fa-fw'></i>" data-btnid="resetPassBtn" data-form="resetPassForm" data-validator="true" data-callback="loginCallback" class="btn btn-lg btn-primary full-width" onclick="_run(this)">Change Password</button>
                ...
                <div class="row" id="email-change-notification">
                    <div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <p class="text-success">Your Password Changed Successfully </p>
                    </div>
                </div>
   ...
   <script>
    function loginCallback(data){
        ...
        if(data.success){
            ...
            $._validator("resetPassForm", data.errors);
        }
    }
   </script>
{% endblock %}
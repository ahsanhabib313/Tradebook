        ...
        <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="ui-block responsive-flex">
                <div class="ui-block-title">
                    <div class="h6 title">Followers (<?= count($followers) ?>)</div>
                    <form class="w-search">
                ...
                <div class="ui-block">
                    ...
                    <div class="friend-item">
                        <div class="friend-header-thumb">
                            <?php
                            $coverImage = App\Models\Attachment::select('name')->where('attachmentable_id', $follower->user_id)->where("attachmentable_type", "cover_image")->orderBy('id', "desc")->first();
                            if (!empty($coverImage->name)) {
                                echo '<img id="previousImg" src="../public/uploads/user/' . $coverImage->name . '" alt="nature">';
                            } else {
                                echo '<img style="max-height:350px" id="previousImg" src="../public/uploads/user/no-image.png" alt="nature">';
                        ...
                        <div class="friend-item-content">
                            ...
                            <div class="friend-avatar">
                                <div class="author-thumb">
                                    <?php
                                    $profilePicture = App\Models\Attachment::select('name')->where('attachmentable_id', $follower->user_id)->where("attachmentable_type", "user")->first();
                                    if (!empty($profilePicture->name)) {
                                ...
                                <div class="author-content">
                                    <a href="profile?id=<?= $follower->user_id ?>" class="h3 author-name"><?= userinfois($follower->user_id, 'name'); ?></a>
                                </div>
                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="friend-count" data-swiper-parallax="-500">
                                            <a href="#" class="friend-count-item">
                                                <div class="h6"><?= totalCopied($follower->user_id) ?></div>
                                                <div class="title">Friends</div>
                                            </a>
                                            <a href="following?id=<?= $follower->user_id ?>" class="friend-count-item">
                                                <div class="h6"><?= totalFollowing($follower->user_id) ?></div>
                                                <div class="title">Followings</div>
                                            </a>
                                            <a href="follower?id=<?= $follower->user_id ?>" class="friend-count-item">
                                                <div class="h6"><?= totalFollower($follower->user_id) ?></div>
                                        ...
                                        <div class="control-block-button" data-swiper-parallax="-100">
                                            ...
                                            if ($userDetails->id != selfInfo('id')) {
                                            ?>
                                                <span onclick="addFriendUnfriendFollowUnfollow(this)" id="follow-btn" data-actiontype="<?= ((userinfois($follower->user_id, 'is_follow')) ? 'unfollow' : 'follow'); ?>" data-friendid="<?= $follower->user_id; ?>" class="btn btn-control cursor-pointer-finger <?= ((userinfois($follower->user_id, 'is_follow')) ? 'bg-danger' : 'bg-success-new'); ?>" data-toggle="tooltip" data-original-title="<?= ((userinfois($follower->user_id, 'is_follow')) ? 'Unfollow' : 'Follow'); ?>">
                                                    <?= ((userinfois($follower->user_id, 'is_follow')) ? '<i class="fas fa-user-minus"></i>' : '<i class="fas fa-user-plus"></i>'); ?>
                                                </span>

                                                <span onclick="addFriendUnfriendFollowUnfollow(this)" id="copy-btn" data-actiontype="<?= ((userinfois($follower->user_id, 'is_friend')) ? 'remove' : 'add'); ?>" data-friendid="<?= $follower->user_id; ?>" class="btn btn-control bg-purple cursor-pointer-finger" data-toggle="tooltip" data-original-title="<?= ((userinfois($follower->user_id, 'is_friend')) ? 'Uncopy' : 'Copy'); ?>">
                                                    <div class="comment-icon livicon-evo" data-options="name: touch.svg;size: 30px; style:lines; strokeColor: #fff;"></div>
                                                </span>
                                            <?php
                                            }
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="friend-since" data-swiper-parallax="-100">
                                            ...
                                            <div class="h6"><?= date("F Y", strtotime($follower->created_at)) ?></div>
                                        </div>
                                    </div>
                                </div>

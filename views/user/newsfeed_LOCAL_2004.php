                ...
                <div class="news-feed-form">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home-1" role="tabpanel" aria-expanded="true">
                            <form action="post-status" method="post" id="post-status-form" enctype="multipart/form-data">
                                ...
                                <div id="content" class="form-group with-icon label-floating is-empty">
                                    ...
                                    <textarea id="get_url" name="status" class="form-control" placeholder="Share what you are thinking here..."></textarea>
                                ...
                                <div id="file-preview-wrappper">
                                    <ul>
                                        <li>
                                            ...
                                            <img src="../public/uploads/user/<?= selfInfo('profile_photo');?>" id="uploadedimg" class="img-item" alt="Preview image" />
                                        </li>
                        ...
                        <div class="tab-pane" id="profile-1" role="tabpanel" aria-expanded="true">
                            <form>
                                <div class="author-thumb">
                                    <img src="../public/uploads/user/<?= selfInfo('profile_photo'); ?>" alt="author">
                                </div>
            ...
            <div id="newsfeed-items-grid">
                ...
                <div class="ui-block">
                    <article class="hentry post">
                        ...
                        <p id="description" class="description_<?= $value->id; ?> show-more-text">{{ $value->post }}</p>
                        <!-- ===============================================
                        ...
                        <div class="post-additional-info inline-items">
                            ...
                            <?php
                                $getLikes = App\Models\Like::where('item_id', '=', $value->id)->select('user_id')->take(5)->get();
                            ?>
                            ...
                            <ul class="friends-harmonic">
                                <?php
                                    ...
                                    $deductLike = 0;
                                ?>
                                {% foreach($getLikes as $likeUser): %}
                                <?php
                                    if($likeUser->user_id == selfInfo('id')){
                                        $selfLikeItIs = true;
                                        $deductLike = 1;
                                    }
                                ?>
                                <li>
                                    <a href="#">
                                        <img src="../public/uploads/user/<?= userinfois($likeUser->user_id, 'profile_photo');?>" alt="<?= $likeUser->user_id;?>">
                                    </a>
                                </li>
                                {% endforeach; %}
                            ...
                            <div class="names-people-likes">
                                <?php
                                    if($selfLikeItIs){
                                ?>
                                <a href="profile?id=<?= selfInfo('id');?>">You</a>,  and
                                <br>
                                <?php
                                    }
                                ?>
                                <?php
                                    ...
                                    if(totallike($value->id) > 0){
                                        echo (totallike($value->id) - $deductLike)." ".(($selfLikeItIs) ? 'more liked this' : 'peoples liked this' );
                                    }
                    ...
                    <div class="comments-wrapper">
                        <ul class="comments-list" id="post-comment-{{$value->id}}" data-item="1" data-size="1">
                            ...
                            <?php
                            $profilePicture = App\Models\Attachment::select('name')->where('attachmentable_id', $comment->comment_by)->where("attachmentable_type", "user")->first();
                            ?>
                    ...
                    <form action="post-comment" method="post" id="comment-form-{{$value->id}}" class="comment-form inline-items" enctype="multipart/form-data">
                        <div class="post__author author vcard inline-items">
                            <img src="../public/uploads/user/<?= selfInfo('profile_photo'); ?>" alt="<?= selfInfo('name'); ?>">
                            <div class="form-group with-icon-right ">
...
<!-- Socket For Post, Comment, Share -->
<script src="../public/socket/new-feed.js"></script>
<script>
    ...
    $(document).ready(function() {
        $(".edit").on("click", function() {
            ...
            const post_id = $(".hidBtn").attr('id');
            let postText = $('.description_' + id).text();
            $("#post-body").val(postText);


            $("#saveEdit").on("click", function() {
                const addedText = $("#post-body").val();
                $.ajax({
                    url: "/user/edit",
                    type: "POST",
                    data: {
                    ...
                    success: function(data) {
                        if (data) {
                            let updatedPost = JSON.parse(data)[0];
                            Swal.fire({

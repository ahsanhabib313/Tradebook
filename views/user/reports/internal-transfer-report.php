...
{% block title %}Internal Transfer Report{% endblock %}
{% block pushInHead %}
...
<!--=================================== Report Section =======================================================================-->
<div class="container" id="internal_transfer_main_content">
            ...
            <div class="card mt-2">
                <div class="card-header p-3 ">
                    ...
                    <div class="card-body p-px-4 py-4">
                        <form autocomplete="off"  action="/user/get/internal-transfer/csv/file?action=export" method="post" id="filter_form">
                           ...
                           <div class="form-row">
                                     <div class="col-md-6">
                                            <div class="form-group">
                                                <select class=" form-control form-control-md" name="type"  id="filter_report_select1" >
                                                    <option class="option" value="" selected>Select Method</option>
                                                    <option class="option" value="" >All</option>
                                                    <option class="option" value="1" >Trading To Wallet</option>
                                                    <option class="option" value="2">Wallet To Trading</option>
                                                </select>
                                            </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <div class="row d-flex justify-content-center " id="internal_transfer_report">
            <div class="col-md-12 mt-5">
                        <div class="card bg-white file_report mb-5">
                            ...
                            <table id="internal_transfer_table" class="display" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Method</th>
                                    ...
                                    <tfoot>
                                           <tr>
                                               <td colspan="6" class="text-right text-dark font-weight-bold">Total Amount:</td>
...
var dt = $('#internal_transfer_table').DataTable({

    "language": { "search": '', "searchPlaceholder": "Search...", "lengthMenu": "_MENU_" },
    "processing": true,
    "serviceSide": false,
    "ajax": {
        "url": '/user/get/internal-transfer-report/data',
        "data": function (d) {

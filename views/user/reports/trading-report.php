...
{% block title %}Trading Report{% endblock %}
{% block pushInHead %}
...
<!--=================================== Report Section =======================================================================-->
<div class="container" id="trading_main_content">
...
<!--=================================== Filter Report =======================================================================-->
            ...
            <div class="card mt-2">
                ...
                <!--=================================== first row of filter form =======================================================================-->
                           <div class="form-row">
                                <div class="col-md-4">
                                            <div class="form-group">
                                                    <select class="form-control form-control-md"  id="filter_report_select2" >
                                                            <option class="option" value="Trader" selected>All Symbol</option>
                                ...
                                <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control email" placeholder="TICKET">
                                        </div>
                                </div>
                               <div class="col-md-4">
                                        <div class="form-group">
                                            <select class=" form-control form-control-md"  id="filter_report_select1" >
                                                <option class="option" value="Trader">Search By Trading Account</option>
 ...
 <!--=================================== withdraw report =======================================================================-->
    <div class="row d-flex justify-content-center " id="trading_report">
            <div class="col-md-12 mt-5">
                        <div class="card bg-white file_report mb-5">
                            ...
                            <table id="trading_table" class="display" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Name</th>
...
var dataTable = $('#trading_table').DataTable({
...
$('#trading_table tbody').on('click', 'td.details-control', function () {

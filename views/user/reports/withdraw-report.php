...
{% block title %}Withdraw Report{% endblock %}
{% block pushInHead %}
...
<div class="main-header">
    ...
    <div class="row">
        ...
        <div class="col col-3">
            ...
            <h1 class="text-left" style="color:#fff;"> <span>$</span><?php selfInfo('account_balance'); ?></h1>
        </div>
        <div class="col col-2">
...
<!--=================================== Report Section =======================================================================-->
<div class="container" id="withdraw_main_content">
...
<!--=================================== Filter Report =======================================================================-->
            ...
            <div class="card mt-2">
                <div class="card-header p-3 ">
                    ...
                    <div class="card-body px-4 py-4">
                        <form autocomplete="off" id="filter_form" action="/user/get/withdraw/csv/file?action=export" method="post">
                            <input type="hidden" name="user_id" value="<?php echo $user->id?>">
                        
                        <!----- for checking is it filter action or export action --->
                               ...
                               <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                            <div class="form-group btnGroup d-flex justify-content-end">
                                                <button  class="btn btn-success btn-md" id="export_btn" btn-name="export">Export</button>
 ...
 <!--=================================== withdraw report =======================================================================-->
    <div class="row d-flex justify-content-center " id="withdraw_report">
            <div class="col-md-12 mt-5">
                        <div class="card bg-white file_report mb-5">
                            ...
                            <table id="withdraw_table" class="display"  style="width:100%">
                                <thead>
                                    <tr>
...
/*** start with draw data table************** */
 var dt = $('#withdraw_table').DataTable({

            "language": { "search": '', "searchPlaceholder": "Search...", "lengthMenu": "_MENU_" },
            "processing": true,
            "serviceSide": false,
            "ajax":{
                "url":'/user/get/withdraw-report/data',
                "data": function(d){
                    ...
                    return $.extend({},d, {
                        ...
                        "action": $('#filter_form').find('input[name="action"]').val(),
                    })
                }
...
$('#filter_btn').click(function (e) {
        	e.preventDefault();
            $('#filter_form').find('input[name="action"]').val('filter'),

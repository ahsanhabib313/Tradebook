...
{% block title %}Balance Transfer Report{% endblock %}
{% block pushInHead %}
...
<!--=================================== Report Section =======================================================================-->
<div class="container" id="balance_transfer_main_content">
...
<!--=================================== Filter Report =======================================================================-->
                ...
                <!--=================================== first row of filter form =======================================================================-->
                           <div class="form-row">
                               <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control transaction_id" placeholder="Transaction ID">
                                        </div>
                                </div>
                                <div class="col-md-4">
                                        <div class="form-group">
 ...
 <!--=================================== withdraw report =======================================================================-->
    <div class="row d-flex justify-content-center " id="balance_transfer_report">
            <div class="col-md-12 mt-5">
                        <div class="card bg-white file_report mb-5">
                            ...
                            <table id="balance_transfer_table" class="display" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Name</th>
...
<!------------------ days js script for data input field---------------->
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.10.7/dayjs.min.js" defer="defer"></script> --> -->
...
var dataTable = $('#balance_transfer_table').DataTable({
...
$('#internal_transfer_table tbody').on('click', 'td.details-control', function () {
